...
[![Actions Status](https://github.com/devapanda/Swapdex-sdk/workflows/CI/badge.svg)](https://github.com/devapanda/swapdex-sdk)
...
```sh
git clone https://github.com/devapanda/swapdex-sdk.git
```
